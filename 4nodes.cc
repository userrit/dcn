...
//tcp
  ...
  devices12 = pointToPoint.Install (nodes.Get(1),nodes.Get(2));
   //udp
   NetDeviceContainer devices31;
  devices31 = pointToPoint.Install (nodes.Get(3),nodes.Get(1));
    NetDeviceContainer devices312;
  devices312 = pointToPoint.Install (nodes.Get(1),nodes.Get(2));
  ...
  Ipv4InterfaceContainer interfaces312 = address.Assign (devices312);
  ...
  InetSocketAddress rmt1 (interfaces312.GetAddress (1), port1);
  rmt.SetTos (0xb8);
